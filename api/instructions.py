no_context_prompt = """
Can you analyse each document and provide an analysis of the article type, which should be one of 'advertising', 'editorial', or 'advertorial'.
A page can be both 'advertising' and 'editorial', as the classification is based on the content of the page, not the overall document. 
Please also provide a reason for the classification. Also provide a confidence score between 0 and 1 for the classification. Response format:
{
